...
.modiButton{
    ...
    <div class="modiButton">MODIFICAR PACIENTE</div>
    <?php
    ...
    while ($reg = mysqli_fetch_array($registros)) { 
        ...
        echo '<td>  <a href="editar_paciente.php?idPaciente='.$reg['idPaciente'].'"><center><div class="editButton">EDITAR</div></center></a> </td>';
        echo "</tr>";
    }
    echo "</table>";
