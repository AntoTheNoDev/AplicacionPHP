...
<?php
    ...
    $nuevo_telefonoFamiliar=$_POST['nuevo_telefonoFamiliar'];
    
    $consulta = "UPDATE pacientes SET dni='$nuevo_dni', 
                                                    nombre='$nuevo_nombre',
                                                    ...
                                                    telefonoFamiliar='$nuevo_telefonoFamiliar'
                                                    WHERE idPaciente=$id";
    if(mysqli_query($conexion,$consulta)){
      echo '<div id="containerTrue">';
      echo "Usuario modificado correctamente";
      echo '<a href="modificar_paciente.php"><div class="myButton3">VOLVER</div></a>';
      echo '</div>';
